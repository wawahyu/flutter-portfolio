...
class _LandingPageState extends State<LandingPage>
  ...
  Widget greeting() {
    return Container(
      width: 130 + MediaQuery.of(context).size.width * 8 / 100,
      height: 80,
      child: Bubble(
            ...
            child: Container(
              child: StreamBuilder<double>(
                  stream: Stream.periodic(Duration(seconds: 5), (i) {
                    ...
                    return random.nextInt(educations.length) / 1;
                  }),
                  builder: (context, snapshot) {
                    int index = 0;
                    if (snapshot.hasData && snapshot.data != null) {
                      index = int.parse(snapshot.data.toString());
                    }
                    return Stack(
                      ...
                      children: List.generate(educations.length, (i) {
                        return AnimatedPositioned(
                          ...
                          right: _tabController.index == 2
                              ? MediaQuery.of(context).size.width * 8 / 100 + 20
  ...
  Widget talk() {
    List<String> talk = [
      'Programmer can absolutely move without any reason. And so can I?',
    ...
    return StreamBuilder<double>(
      stream: Stream.periodic(Duration(seconds: 5), (i) {
        Random random = Random();
        return random.nextInt(talk.length) / 1;
      }),
      builder: (context, snapshot) {
        int index = 0;
        if (snapshot.hasData && snapshot.data != null) {
                    ...
                    child: Container(
                      ...
                      child: Stack(
                        children: [
                          ...
                          Positioned(
                            top: MediaQuery.of(context).size.width * 10 / 100,
                          ...
                          Positioned(
                            bottom:
                                MediaQuery.of(context).size.width * 23 / 100,
                            right: 250,
                            child: AnimatedContainer(
                              duration: Duration(milliseconds: 200),
                              height: 120,
